...
ccflags := -c -O -g --std=gnu11 -fplan9-extensions $(shell /usr/local/bin/sdl2-config --cflags) \
			-D LINUX_TARGET
wccflags = -c -O -g --std=gnu11 -fplan9-extensions $(addprefix -I, $(wsdlincdirs)) \
			-D WINDOWS_TARGET
...
wsdllibdirs = $(wsdldir)\SDL2-2.0.4\i686-w64-mingw32\lib \
				$(wsdldir)\SDL2_ttf-2.0.14\i686-w64-mingw32\lib
...
win: wshare $(winobjs) $(wsdlobjs) $(winheads) $(sdlheads)
	...
	gcc -o $(exebasename)_lnx $(winobjs) $(wshareobjs) $(wsdlobjs) $(wldflags) -lSDL2_ttf
